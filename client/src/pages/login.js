  ...
  return (
    <div className="auth-screen">
      ...
      <main className="auth-layout">
        ...
        {/* LEFT PANEL */}
        <section className={`auth-panel ${switching ? "switching" : ""}`}>
          ...
          <div className="field-group">
            ...
            <div className="input-shell">
              ...
              <input
                ...
                className="auth-input"
              />
              <span className="input-trailing"><EyeOffIcon /></span>
            </div>
          </div>
          ...
          <div className="auth-switch">
            <button className="switch-btn switch-btn-active">LOG IN</button>
